  ...
  <div class="delivered-orders-container">
    ...
    <div v-if="loading" class="loading-container">
      <div class="no-data">
        ...
        <div class="no-data-description">正在获取已交付订单数据</div>
      </div>
    </div>
    ...
    <div v-else-if="orders.length === 0" class="empty-container">
      <div class="no-data">
        <div class="no-data-icon">🎉</div>
        <div class="no-data-title">暂无已交付订单</div>
        <div class="no-data-description">当前没有已交付的订单</div>
      </div>
    </div>
          ...
          <div class="delivery-info">
            ...
            <div class="delivery-grid">
              <div class="delivery-item">
                ...
                <span class="delivery-value delivered">✅ 已交付</span>
              </div>
              <div class="delivery-item">
                <span class="delivery-label">交付时间:</span>
                <span class="delivery-value">{{ formatDate(order.deliveryDate || order.orderDate) }}</span>
              </div>
              <div class="delivery-item" v-if="order.trackingNumber">
                <span class="delivery-label">追踪号码:</span>
                <span class="delivery-value">{{ order.trackingNumber }}</span>
              </div>
            </div>
          </div>
...
import { getLogisticsDeliveredOrders } from '../../utils/api.js'
...
const loadOrders = async () => {
  try {
    ...
    const response = await getLogisticsDeliveredOrders(userId)
